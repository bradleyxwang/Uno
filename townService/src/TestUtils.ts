...
export class MockedPlayer {
  ...
  login(googleEmail: string | undefined, googleAccountName: string | undefined): void {
    const onLogin = getEventListener(this.socket, 'playerLoginLogout');
    onLogin(googleEmail, googleAccountName);
  }
